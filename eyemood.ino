...
Stepper* steppers[] = {
  /* 0  0b00000 */  new Rainbow(2000),
  /* 1  0b00001 */  new PendulumLeftRight(COLOR_RED, COLOR_BLUE, COLOR_RED),
  /* 2  0b00010 */  new PendulumLeftRight(COLOR_CYAN, COLOR_LIGHT_PURPLE, COLOR_CYAN),
  /* 3  0b00011 */  new PendulumLeftRight(COLOR_LIGHT_PURPLE, COLOR_GREEN, COLOR_LIGHT_PURPLE),
  /* 4  0b00100 */  new Blink(COLOR_RED, COLOR_WHITE),
  /* 5  0b00101 */  new Blink(COLOR_BLUE, COLOR_GREEN),
  /* 6  0b00110 */  new SpinningFadeInOut(170, 0, 200, 3, COLOR_CYAN),
  /* 7  0b00111 */  new SpinningFadeInOut(0, 255, 170, 4, COLOR_RED),
  /* 8  0b01000 */  new SpinningFadeInOut(100, 0, 150, 3, COLOR_GREEN),
  /* 9  0b01001 */  new TwoColorRotatingStepper(COLOR_RED, COLOR_BLUE),
  /* 10 0b01010 */  new TwoColorRotatingStepper(COLOR_BLUE, COLOR_GREEN),
  /* 11 0b01011 */  new TwoColorRotatingStepper(COLOR_RED, COLOR_GREEN),
  /* 12 0b01100 */  new OnePixelSpinner(COLOR_RED),
  /* 13 0b01101 */  new OnePixelSpinner(COLOR_GREEN),
  /* 14 0b01110 */  new OnePixelSpinner(eyes.Color(0, 150, 150)),
  /* 15 0b01111 */  new FadeInOut(255, 0, 200),
  /* 16 0b10000 */  new FadeInOut(0, 0, 255),
  /* 17 0b10001 */  new Sparkle(3, eyes.Color(255, 0, 0)),
  /* 18 0b10010 */  new Sparkle(1, eyes.Color(255, 255, 255)),
  /* 19 0b10011 */  new TwoPixelSpinner(COLOR_CYAN),
  /* 20 0b10100 */  new TwoPixelSpinner(COLOR_LIGHT_PURPLE),
  /* 21 0b10101 */  new TwoPixelSpinner(COLOR_GREEN),
  /* 22 0b10110 */  new TwoPixelTwoColorSpinner(COLOR_RED, COLOR_BLUE),
  /* 23 0b10111 */  new TwoPixelTwoColorSpinner(COLOR_GREEN, COLOR_BLUE),
  /* 24 0b11000 */  new TwoPixelTwoColorSpinner(COLOR_CYAN, COLOR_LIGHT_PURPLE),
  /* 25 0b11001 */  new TwoCounterRotating(COLOR_RED, COLOR_BLUE),
  /* 26 0b11010 */  new TwoCounterRotating(COLOR_GREEN, COLOR_RED),
  /* 27 0b11011 */  new TwoCounterRotating(eyes.Color(255, 0, 255), eyes.Color(165, 170, 0)),
  /* 28 0b11100 */  new FadeInOutSpinner(0, 255, 0, eyes.Color(255, 0, 255)),
  /* 29 0b11101 */  new FadeInOutSpinner(255, 0, 0, COLOR_BLUE),
  /* 30 0b11110 */  new FadeInOutSpinner(0, 255, 0, COLOR_CYAN),
  /* 31 0b11111 */  new Rainbow(-5000)
};
